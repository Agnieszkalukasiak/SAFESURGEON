# Generated by Django 4.2.15 on 2024-09-13 10:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cities', to='SafeSurgeon.city')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='countries', to='SafeSurgeon.country')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='surgeon_verification', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Education',
